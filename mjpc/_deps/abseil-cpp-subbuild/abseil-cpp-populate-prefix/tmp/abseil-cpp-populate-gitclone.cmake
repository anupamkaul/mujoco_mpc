...
if(EXISTS "/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-subbuild/abseil-cpp-populate-prefix/src/abseil-cpp-populate-stamp/abseil-cpp-populate-gitclone-lastrun.txt" AND EXISTS "/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-subbuild/abseil-cpp-populate-prefix/src/abseil-cpp-populate-stamp/abseil-cpp-populate-gitinfo.txt" AND
  ...
  message(STATUS
    ...
    "'/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-subbuild/abseil-cpp-populate-prefix/src/abseil-cpp-populate-stamp/abseil-cpp-populate-gitclone-lastrun.txt'"
  )
  return()
endif()

execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-src"
  RESULT_VARIABLE error_code
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: '/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-src'")
endif()
...
execute_process(
  ...
  WORKING_DIRECTORY "/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-src"
  RESULT_VARIABLE error_code
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: '/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: '/home/anupam/github_robotics/simulator/mujoco_mpc/mjpc/_deps/abseil-cpp-subbuild/abseil-cpp-populate-prefix/src/abseil-cpp-populate-stamp/abseil-cpp-populate-gitclone-lastrun.txt'")
endif()
