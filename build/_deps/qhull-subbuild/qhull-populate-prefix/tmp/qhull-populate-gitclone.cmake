...
if(EXISTS "/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-subbuild/qhull-populate-prefix/src/qhull-populate-stamp/qhull-populate-gitclone-lastrun.txt" AND EXISTS "/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-subbuild/qhull-populate-prefix/src/qhull-populate-stamp/qhull-populate-gitinfo.txt" AND
  ...
  message(STATUS
    ...
    "'/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-subbuild/qhull-populate-prefix/src/qhull-populate-stamp/qhull-populate-gitclone-lastrun.txt'"
  )
  return()
endif()

execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-src"
  RESULT_VARIABLE error_code
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: '/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-src'")
endif()
...
execute_process(
  ...
  WORKING_DIRECTORY "/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-src"
  RESULT_VARIABLE error_code
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: '/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: '/home/anupam/github_robotics/simulator/mujoco_mpc/build/_deps/qhull-subbuild/qhull-populate-prefix/src/qhull-populate-stamp/qhull-populate-gitclone-lastrun.txt'")
endif()
